 ...
 */
export function categoriesFromTypeConfig(
  types: readonly PoiTypeConfigLike[],
): PoiCategory[] {
...
export function isBuiltinPoiCategoryId(value: string): value is Exclude<PoiCategoryId, string & {}> {
  return BUILTIN_CATEGORY_IDS.includes(value);
}

export function getPoiCategory(id: PoiCategoryId, categories?: readonly PoiCategory[]): PoiCategory | undefined {
